...
| --threads       | How many CPU threads to use on transcription. The default is 4. Increasing this number will make whisperx faster, but will cause problems if you increase it above how many threads your CPU has.. | any number 1 or greater.                                                                        |
